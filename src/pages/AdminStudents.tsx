    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4">
        {filteredStudents.map(student => (
          <div key={student.student_id} className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm transition-all hover:shadow-md">
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <input 
                      type="text" 
                      className="w-full p-2 bg-gray-50 border border-gray-100 rounded-lg focus:outline-none opacity-50"
